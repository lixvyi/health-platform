...
-- 初始数据资源（关联开放数据目录）
INSERT IGNORE INTO portal_data_resource (code, name, category, source, description, data_type, size_label, permission_level, open_data_id, sort_order) VALUES
...
-- 初始 API 服务
INSERT IGNORE INTO portal_api_service (code, name, description, method, path, params_json, response_example, permission_level, sort_order) VALUES
