...
public class DataGovernanceSchemaInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            jdbcTemplate.execute("""
                    ...
                    """);
            seedIssues();
            log.info("Data governance schema ready");
        } catch (Exception e) {
            log.warn("Data governance schema init skipped: {}", e.getMessage());
        }
    }
